...
ui: retail-store-sample-ui:1.2.2
catalog: retail-store-sample-catalog:1.2.2
cart: retail-store-sample-cart:1.2.2
checkout: retail-store-sample-checkout:1.2.2
orders: retail-store-sample-orders:1.2.2
...
dynamodb-local: aws-dynamodb-local:1.25.1
```
...
ui: retail-store-ui:{COMMIT_HASH}
catalog: retail-store-catalog:{COMMIT_HASH}
cart: retail-store-cart:{COMMIT_HASH}
checkout: retail-store-checkout:{COMMIT_HASH}
orders: retail-store-orders:{COMMIT_HASH}
...
Error: Failed to pull image "retail-store-ui:abc1234"
